...
def main(input_ldif_path, log_file_path, canale):
    valid_output_file_name = f"/mnt/c/temporary/wind/migrationUsersProcedure/{canale}_parentuid_child_FINAL.ldif"
    eliminated_output_file_name = f"/mnt/c/temporary/wind/migrationUsersProcedure/{canale}_parentuid_child_eliminated.ldif"
...
if __name__ == "__main__":
    ...
    canale = "FR"
    input_ldif_path = f"/mnt/c/temporary/wind/migrationUsersProcedure/{canale}_parentuid_child.ldif"
